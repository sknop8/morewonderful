...
function findFundamentalFreq(buffer, sampleRate) {
  ...
  var bestR = 0 // correlation
  var bestK = -1 // period we are trying to find
  ...
  // if high enough correlation, get the fundamental freq from the period
	if (bestR > 0.0025) { return sampleRate / bestK }
}
